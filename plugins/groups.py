...
async def mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 6396782078:
            return await msg.edit("✪ لا يمكنك كتم ميكو")
...
async def un_mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 6396782078:
            return await msg.edit("✪ لا يمكنك الغاء كتم ميكو")
...
async def bann(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 6396782078:
        return await msg.edit("✪ لا يمكنك حظر ميكو")
    try:
...
async def un_ban(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 6396782078:
        return await msg.edit("✪ لا يمكنك الغاء حظر ميكو")
    try:
