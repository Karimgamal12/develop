...
async def shark1(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر الخاص في سورس المرتجل  ⦒
✪ تفعيل ، تعطيل الترحيب 
✪ قبول ، رفض
✪ كتم ، الغاء كتم 
✪ سبام + الكلمه + الرقم (سبام المرتجل 22)
✪ ايدي + ايدي بالرد
✪ انتحال ● رجوع
✪=====⧼ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
""",
...
async def shark2(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر الجروبات في سورس المرتجل  ⦒
✪ حظر ، الغاء حظر
✪ مسح المحظورين
✪ كتم ، الغاء كتم 
✪ مسح المكتومين
...
async def shark3(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر اليوتيوب في سورس المرتجل  ⦒
✪ غ + اسم الاغنيه
✪ ف + اسم الفيديو
✪=====⧼ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
""",
...
async def shark4(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر الاذاعه في سورس المرتجل  ⦒
...
async def shark5(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر الرفع في سورس المرتجل  ⦒
...
async def shark6(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة الاوامر الاضافيه في سورس المرتجل  ⦒
...
async def shark7(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر التسليه في سورس المرتجل  ⦒
✪ `.مكعبات`
✪ `.قمر`
✪ `.قلوب`
✪ `.قلب`
...
async def shark8(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر التسليه 2 في سورس المرتجل  ⦒
✪ `.غبي`
✪ `.تفجير`
✪ `.طوبه`
✪ `.مربعات`
...
async def shark9(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر التسليه 3 في سورس المرتجل  ⦒
✪ `.رموز شيطانيه`
✪ `.اسعاف`
✪ `شرطه`
✪ `.زعلت`
...
✪ `.عبقري`
✪ `.قتل`
✪ انتظرو تحديثات عظمه ل تليثون سورس المرتجل 🔥
✪=====⧼ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
""",
    ]
    for i in animation_ttl:
...
async def shark10(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر الالعاب في سورس المرتجل  ⦒
 ✪ `.اكس او` 
...
async def shark11(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر الالعاب المتطوره في سورس المرتجل  ⦒
 ✪ `.القط المجنون` 
✪ `.ركل الكره`
✪ `.السمك الشائك`
✪ `.كرة السله`
...
async def shark12(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر الميمز في سورس المرتجل  ⦒
✪ `.هنضحك`
✪ `.مينفعش`
...
async def shark13(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر الميمز 2 في سورس المرتجل  ⦒
✪ `.في رمضان`
✪ `.مش عارف اقوم`
✪ `.دمك خفيف اوي`
...
async def shark14(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر الميمز 3 في سورس المرتجل  ⦒
✪ `.تاخد نفس عميق`
✪ `.ربنا نصرني`
✪ `.لو معايا خنجرين`
✪ `.اماااال`
...
async def shark15(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎](https://t.me/P_PP_Pi) ⧽=====✪
: ⦑   قائمة اوامر النسب في سورس المرتجل  ⦒
✪ `.نسبة الانوثة`
✪ `.نسبة الغباء`
✪ `.نسبة الرجولة`
✪ `.نسبة المنيكه`
...
async def source(c,msg):
  await msg.edit("⋖⊶◎⊷⌯𝐒𝐎𝐔𝐑𝐂𝐄 ✪ 𝐘𝐒𝐎⌯⊶◎⊷⋗\n✪ ¦ [↱ ᯓ 𓆩 يسو الدليمي ↲](t.me/I_RA6)\n✪ ¦ [𝙎𝙐𝙋𝙋𝙊𝙍𝙏 𖧊 𝐘𝐒𝐎](t.me/P_PP_Pi2)\n✪ ¦ [𝐒𝐎𝐔𝐑𝐂𝐄 𖧊 𝐘𝐒𝐎](t.me/P_PP_Pi)\n⋖⊶◎⊷⌯𝐒𝐎𝐔𝐑𝐂𝐄 ✪ 𝐘𝐒𝐎⌯⊶◎⊷⋗")
